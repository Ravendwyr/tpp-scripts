...
function fetchFromGitHub() {
    Promise.all([
        ...
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/follower_bot_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/hate_troll_list_0_g.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/hate_troll_list_h_m.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/hate_troll_list_n_z.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/mad_tos_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/security_ban_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/seller_advertising_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/spam_bot_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/streamsniper_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/viewer_bot_list.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/isdsdataarchive/twitch_ban_lists/main/whitelisted_bots.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
