...
function fetchFromGitHub() {
    Promise.all([
        ...
        fetch('https://raw.githubusercontent.com/mdgdevsecurity/twitch_ban_list/main/hate_troll_list_a_m.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
        fetch('https://raw.githubusercontent.com/mdgdevsecurity/twitch_ban_list/main/hate_troll_list_n_z.txt', { method: 'GET', retry: 3, pause: 1000, silent: true }).then(data => data.text()),
